...
function SongsList({ songs, setSelectedSong, selectedSong, isPlaying }) {
    return (
        <ul className="songs-list polka-dot-bg">
            {songs.map(song => {
                let liClass = '';
                ...
                return (
                    ...
                    >
                        ...
                        <img className="artwork" src={song.artworkUrl} alt={song.trackName} />
                        <div className="info">
                            <div className="info-name">{song.trackName}</div>
                            <div className="info-artist">{song.artistName}</div>
                        </div>
                    </li>
                )
            })
