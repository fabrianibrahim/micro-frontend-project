...
},{}],"8EI4w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function downloadDocument(url, timeoutMs = 5000) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        request.onload = ()=>{
            if (request.status >= 400) reject(new Error(`Received HTTP Status ${request.status} for ${url}`));
...
function moveNodeToDocument(parent, document1) {
    return function moveNode(node) {
        ...
        if (node.tagName === "SCRIPT") {
            const clonedNode = document1.createElement(node.tagName);
            [
                ...node.attributes
